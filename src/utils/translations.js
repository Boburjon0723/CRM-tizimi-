export const translations = {
    uz: {
        ...
        orders: {
            ...
            listPrintHint:
                'Yashil — narx va jami; kulrang — faqat mahsulot, kod, rang va son (narxsiz). Filtr, qidiruv va kategoriya natijasi chop etiladi. Bitta buyurtma uchun qatordagi chop tugmalarini bosing.',
            filterByCategory: 'Kategoriya bo\'yicha filtrlash',
            allCategories: 'Barcha kategoriyalar',
            printCategoryOnly: 'Faqat kategoriya',
            printCategoryEmpty: 'Tanlangan kategoriyada chop etish uchun mahsulot yo\'q.',
            productCode: 'Kod',
    ...
    ru: {
        ...
        orders: {
            ...
            listPrintHint:
                'Зелёная кнопка — с ценами и суммой; серая — только товар, код, цвет и количество. Учитываются фильтр, поиск и категория. Для одного заказа нажмите кнопки печати в строке.',
            filterByCategory: 'Фильтр по категории',
            allCategories: 'Все категории',
            printCategoryOnly: 'Только категория',
            printCategoryEmpty: 'В выбранной категории нет товаров для печати.',
            productCode: 'Код',
    ...
    en: {
        ...
        orders: {
            ...
            listPrintHint:
                'Green: prices and line totals. Gray: items only (no prices). Uses status filter, search, and category. For one order, use the row print buttons.',
            filterByCategory: 'Filter by category',
            allCategories: 'All categories',
            printCategoryOnly: 'Category only',
            printCategoryEmpty: 'No items in the selected category to print.',
            productCode: 'Code',
